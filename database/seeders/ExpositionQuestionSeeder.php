        ...
        $expositionGroupQuestions = [
            ...
            "exposition_group_noise_level" => [
                [
                    ...
                    "options" => [
                        "L’utilisation des outils électroportatifs et machines listés dans la partie \"Présentation de la structure\" à partir de la page n°5 de ce Document Unique environ XX minutes par jour en moyenne sur l'année ne génère pas un niveau d'exposition au bruit rapporté à une période de référence de huit heures supérieur à 81 dB(A).",
                        "L’utilisation des outils électroportatifs et machines listés dans la partie \"Présentation de la structure\" à partir de la page n°5 de ce Document Unique environ XX minutes par jour en moyenne sur l’année ne génère pas un niveau d’exposition au bruit rapporté à une période de référence de huit heures supérieur à 81 dB(A) grâce au port permanent de protections auditives.",
