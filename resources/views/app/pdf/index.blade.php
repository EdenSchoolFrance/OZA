...
<body class="pdf">
    <section class="page page--first">
        ...
        <div class="body">
            <div class="header">
                ...
                <p class="info">Transcription des résultats de l'évaluation des risques pour la santé et la
                    sécurité du
                    personnel</p>
            </div>
            ...
            <div class="info-single_document">
                <p>
                    @if (count($single_document->histories) === 1)
                        Document Unique élaboré le
                    @else
                        Mise à jour du DUERP le
                    @endif: <span class="bold">{{ $date }}</span>
                </p>
    ...
    <section class="page page--second">
        ...
        <div class="body">
            <div class="header">
                ...
                <p class="info">Le document unique d'évaluation des risques professionnels est transmis par
                    l'employeur à
                    chaque mise à jour au service de prévention et de santé au travail auquel il adhère.</p>
            </div>
            <ul>
                <li class="bold">
                    <p>Article R4121-4 du Code du Travail <br>Ce document unique d'évaluation des risques
                        professionnels et ses versions antérieures sont tenus, pendant une durée de 40 ans à compter
                        de leur
                        élaboration, à la disposition de :</p>
                </li>
                <li>
                    <p>
                        1° Des travailleurs et des anciens travailleurs pour les versions en vigueur durant leur
                        période
                        d'activité dans l'entreprise.
                        La communication des versions du document unique antérieures à celle en vigueur à la date de
                        la
                        demande peut être limitée aux seuls éléments afférents à l'activité du demandeur.
                        Les travailleurs et anciens travailleurs peuvent communiquer les éléments mis à leur
                        disposition aux
                        professionnels de santé en charge de leur suivi médical ;
                    </p>
                </li>
                <li>
                    <p>2° Des membres de la délégation du personnel du comité social et économique ;</p>
                </li>
                <li>
                    <p>3° Du service de prévention et de santé au travail ;</p>
                </li>
                <li>
                    <p>4° Des agents du système d'inspection du travail ;</p>
                </li>
                <li>
                    <p>5° Des agents des services de prévention des organismes de sécurité sociale ;</p>
                </li>
                <li>
                    <p>6° Des agents des organismes professionnels de santé, de sécurité et des conditions de
                        travail des
                        branches d'activités présentant des risques particuliers ;</p>
                </li>
                <li>
                    <p>7° Des inspecteurs de la radioprotection et de la santé publique, en ce qui concerne les
                        résultats
                        des évaluations liées à l'exposition des travailleurs aux rayonnements ionisants, pour les
                        installations et activités dont ils ont respectivement la charge.</p>
                </li>
                <li>
                    <p>
                        Jusqu'à l'entrée en vigueur de l'obligation de dépôt du document unique d'évaluation des
                        risques
                        professionnels sur un portail numérique, l'employeur conserve les versions successives du
                        document
                ...
                <li>
                    <p>
                        Un avis indiquant les modalités d'accès des travailleurs au document unique est affiché à
                        une place
                        convenable et aisément accessible dans les lieux de travail. Dans les entreprises ou
                        établissements
                        dotés d'un règlement intérieur, cet avis est affiché au même emplacement que celui réservé
                        au
                        règlement intérieur.
                    </p>
                </li>
    ...
    <section class="page">
        ...
        <div class="body">
            ...
            <ul class="list-item">
                <li>
                    <p><span class="line"><a href="#actu" class="link">ACTUALISATION DU DOCUMENT
                                UNIQUE</a></span></p>
                </li>
                <li>
                    <p><span class="line"><a href="#structure" class="link">PRÉSENTATION DÉTAILLÉE DE LA
                                STRUCTURE ET DES UNITÉS DE TAVAIL</a></span>
                    </p>
                </li>
                <li>
                    <span class="number">1</span>
                    <p><span class="line"><a href="#tabBord" class="link">TABLEAU DE BORD DE L’EVALUATION DES
                                RISQUES</a></span></p>
                </li>
                <li>
                    <span class="number">2</span>
                    <p><span class="line"><a href="#proAnnuel" class="link">PROGRAMME ANNUEL DE PREVENTION ET
                                D'AMELIORATION DES CONDITIONS DE TRAVAIL</a></span>
                    </p>
                </li>
                <li>
                    <span class="number">3</span>
                    <p><span class="line"><a href="#rules" class="link">RAPPEL REGLEMENTAIRE DOCUMENT
                                UNIQUE</a></span></p>
                </li>
                <li>
                    <span class="number">4</span>
                    <p><span class="line"><a href="#evalRisk" class="link">NOTICE DE L’EVALUATION DES
                                RISQUES</a></span></p>
                </li>
                <li>
                    <span class="number">5</span>
                    <p><span class="line"><a href="#evalRiskPro" class="link">EVALUATION DES RISQUES
                                PROFESSIONNELS PAR <span class="bold">UNITÉ DE TRAVAIL</span>, classement
                                alphabétique</a></span>
                    </p>
                </li>
                <li>
                    <span class="number">6</span>
                    <p><span class="line"><a href="#listPost" class="link">LISTE DES POSTES DE TRAVAIL A RISQUE
                                PARTICULIER</a></span></p>
                </li>
                <li>
                    <span class="number">7</span>
                    <p><span class="line"><a href="#evalRiskPsycho" class="link">EVALUATION DETAILLEE DU RISQUE
                                PSYCHOSOCIAL ET <span>PLAN D’ACTION</span>
                                @if ($single_document->risk_psycho === 0)
                                    (partie non présente dans ce DUERP)
                                @endif
                            </a>
                        </span>
                    </p>
                ...
                <li>
                    ...
                    <p><span class="line"><a href="#evalRiskChemical" class="link">EVALUATION DETAILLEE DU
                                RISQUE CHIMIQUE ET <span>PLAN D’ACTION</span>
                                @if ($single_document->risk_chemical === 0)
                                    (partie non présente dans ce DUERP)
                                @endif
                            </a>
                        </span>
                ...
                <li>
                    ...
                    <p><span class="line"><a href="#evalRiskExplosion" class="link">DOCUMENT RELATIF A LA
                                PREVENTION CONTRE L’EXPLOSION ET <span>PLAN D’ACTION</span>
                                @if ($single_document->risk_explosion === 0)
                                    (partie non présente dans ce DUERP)
                                @endif
                            </a></span>
                    </p>
                ...
                <li>
                    ...
                    <p><span class="line"><a href="#expoRiskPro" class="link">EXPOSITION AUX FACTEURS DE RISQUES
                                PROFESSIONNELS ET <span>PLAN D’ACTION</span></a></span>
                    </p>
                </li>
                <li>
                    <span class="number">11</span>
                    <p><span class="line"><a href="#historie" class="link">HISTORIQUE DES ACTIONS
                                REALISÉES</a></span></p>
                </li>
                <li class="no-border">
                    <p><span class="line">Les annexes peuvent être consultées et imprimées depuis votre
                            application DU OZA Online</span>
                    </p>
                </li>
            </ul>
        </div>
            ...
            <table class="table table--document_versions">
                <thead>
                    ...
                    <tr>
                        ...
                        <td rowspan="2" class="theader"> Travail réalisé sur le DU <br><span
                                class="description">(Mise à jour annuelle, mise à jour des actions, mise à jour des
                                évaluations, ajout ou retrait de risques ou de préventions, …)</span>
                        </td>
                ...
                <tbody>
                    @foreach ($single_document->histories as $historie)
                        <tr>
                            <td class="name center">{{ $single_document->firstname }}
                                {{ $single_document->lastname }}</td>
        ...
        <div class="body">
            ...
            <table class="table table--info-gen">
                ...
                <tbody>
                    <tr>
                        <td colspan="2">
                            Ce Document Unique et ses différentes versions a été rédigé sous la responsabilité de
                            l’employeur
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            ...
                            {{ $single_document->adress }}, {{ $single_document->city_zipcode }}
                            {{ $single_document->city }}
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <span class="bold">Nombre de salarié(s) inscrit(s) sur le registre du personnel au
                                moment de la rédaction du Document Unique : </span><br>
                            {{ $numberEmUt }} salarié(s) <br>
                        </td>
                    </tr>
                </tbody>
            </table>
            <p class="text-color-red"><span class="bold">À noter :</span> le genre masculin, utilisé dans la
                rédaction de ce
    ...
    <section class="page">
        ...
        <div class="body">
            ...
            <p class="info text-color-red" style="position: absolute; top: 800px">
                <span class="bold">Rappel :</span> Pour chaque unité de travail, l’évaluation des risques porte
                sur
            ...
            <div class="body">
                <table class="table table--work_unit">
                    ...
                    <tbody>
                        ...
                        @endphp
                        <tr>
                            <td><span class="bold">{{ $sd_work_unit->name }} -
                                    {{ $sd_work_unit->number_employee }} salarié(s)</span></td>
                        </tr>
                        <tr>
                            <td>
                                <p>
                        ...
                        <tr>
                            <td>
                                <p>
                                    <span class="bold">Engin(s) et appareil(s) de manutention mécanique :
                                    </span><br>
                ...
                <tr>
                    <td>
                        <div>
                            ...
                            <p>
                                Permet de situer le niveau de risque total de la structure, évalué sans prendre en
                                compte
                                les mesures de prévention ; sur une échelle de zéro (risque nul) à 50 (risque
                                maximal).
                            </p>
                    ...
                    <td>
                        <div>
                            ...
                            <p>
                                Réduction du risque BRUT grâce aux mesures de prévention existantes : met en
                                évidence les
                    ...
                    <td>
                        <div>
                            ...
                            <p>
                                Permet de situer le niveau de risque actuel de la structure, en prenant en compte
                                les
    ...
    <section class="page">
        ...
        <div class="body body--notif">
            <h1 class="head-title" id="proAnnuel">2. PROGRAMME ANNUEL DE PREVENTION ET D'AMELIORATION DES
                CONDITIONS DE
                TRAVAIL</h1>
            <p class="bold">Le PROGRAMME ANNUEL DE PREVENTION ET D'AMELIORATION DES CONDITIONS DE TRAVAIL reprend
                et
                présente tous les risques identifiés et évalués dans le chapitre 5 "Evaluation des risques" classés
                ici
                selon leur criticité (priorité) dans la colonne "Criticité".</p>
            <p class="bold">Le PROGRAMME ANNUEL DE PREVENTION ET D'AMELIORATION DES CONDITIONS DE TRAVAIL reprend
                et
                présente également toutes les situations de "non-conformité réglementaire" dans la colonne "Mesures
                de
                prévention et de protection à mettre en place", sous le libellé "Obligation réglementaire".</p>
            <p>
                <span class="bold">Colonne "Mesures de prévention et de protection à mettre en place"
                    :</span><br>
                Les mesures de prévention et de protection proposées se déclinent en 3 catégories énoncées dans les
                9
                principes de prévention de l'article L.4121-2 du Code du Travail (Loi n° 91-1414 du 31 décembre 1991
                art. 1
            ...
            <p>
                <span class="">L'employeur décidera quelle(s) mesure(s) proposée(s) il mettra en
                    place.</span><br>
            </p>
            <p>
                <span class="bold">Colonne "Date de réalisation prévue, Conditions d’exécution, Estimation du
                    coût, Ressources nécessaires" :</span><br>
                ...
                Préciser également les actions que l'employeur ne valide pas et qui ne seront pas mises en place.
                <br>
            </p>
            <p>
                <span class="bold">Colonne « Date de réalisation » :</span>
                Inscrire la date à laquelle l'action de prévention ou de protection a réellement été mise en place
                et a été
                opérationnelle.<br>
            </p>
        </div>
    ...
    <section class="page">
        ...
        <div class="body">
            <table class="table table--action">
                <thead>
                    <tr>
                        <th colspan="8" class="green">2. PROGRAMME ANNUEL DE PREVENTION ET D'AMELIORATION DES
                            CONDITIONS DE
                            TRAVAIL
                        </th>
                    </tr>
                    <tr>
                        ...
                        <td class="theader">
                            Date de réalisation prévue <br> Conditions d’exécution <br> Estimation du coût <br>
                            Ressources
                            nécessaires
                        </td>
                        <td class="theader">
                ...
                <tbody>
                    @foreach ($sd_risks as $sd_risk)
                        @if (count($sd_risk->sd_restraints->where('exist', 0)) >= 1)
                            ...
                            <tr>
                                <td class="workunit">
                                    {{ $sd_risk->sd_work_unit ? $sd_risk->sd_work_unit->name : 'Tous' }}</td>
                                <td class="danger">{{ $sd_risk->sd_danger->danger->name }}</td>
                                <td class="risk">@stripTags($sd_risk->name)</td>
                                <td class="risk_residuel center">
                                    {{ count($existsSDrestraints) ? $sd_risk->totalRR($existsSDrestraints) : $sd_risk->total() }}
                                </td>
                                <td
                                    class="criticity center {{ count($existsSDrestraints)
    ...
    <section class="page">
        ...
        <div class="body body--notif">
            ...
            <p class="bold">L’EVALUATION DES RISQUES, LE DOCUMENT UNIQUE ET SON ANNEXE « FACTEURS DE RISQUES
                PROFESSIONNELS
                »</p>
            <p>
                <span class="bold">1. Pourquoi évaluer les risques professionnels ?</span><br>
                L’évaluation des risques professionnels est imposée par le Code du Travail à tout employeur, dès
                lors qu’il
            ...
            <p>
                ...
                Le point de départ de l’évaluation des risques réside dans la volonté du législateur de réduire le
                nombre
            ...
            <p>
                ...
                Le dictionnaire LAROUSSE définit l’<span class="bold">ACCIDENT</span> comme : « un événement
                fortuit qui a
            ...
            <p>
                ...
                <span class="bold">L’accident : </span>Un salarié se coupe à l’index avec une tronçonneuse
                électroportative
                en tronçonnant un fer à béton.<br>
                Dans cet exemple, <br>
                <span class="bold">- Le danger</span> est constitué par la rotation du disque de la tronçonneuse.
                <br>
                <span class="bold">- Le risque</span> est constitué par la probabilité que le disque en rotation
                entre en
    ...
    <section class="page">
        ...
        <div class="body body--notif">
            <p>
                ...
                Ce risque de coupure peut être plus ou moins important. Il variera en fonction de ses deux
                paramètres
                constitutifs :<br>
                <span class="bold">- Le Danger et,</span> <br>
                <span class="bold">- Le Danger</span> <br>
                <span class="bold">Le danger</span> ne variera qu’en fonction de peu de paramètres, notamment la
                vitesse de
                rotation et l’état du disque.<br>
                <span class="bold">L’exposition</span> variera en fonction de paramètres plus nombreux, notamment
                la
                protection du disque, la protection des doigts de la main, la
                connaissance du danger par l’utilisateur, la bonne utilisation de la tronçonneuse, la vitesse
                d’exécution du
                geste, la vigilance de l’utilisateur, etc. ... <br>
            </p>
            <p>
                <span class="bold">L’EVALUATION</span> est définie dans le dictionnaire LAROUSSE comme « l’action
                de
                déterminer la valeur de quelque chose ».<br>
                L’évaluation des risques consistera donc à déterminer la valeur des risques. Pour cela il faudra
                identifier
                ...
                <span class="bold">- Identifier et caractériser les expositions aux dangers au cours de toutes
                    les activités professionnelles.</span><br>
            ...
            <p>
                <span class="bold">2.2. La place de l’évaluation des risques dans la démarche de
                    prévention</span> <br>
                L'article L. 4121-2 du code du travail énonce les 9 principes qui doivent guider la démarche de
                prévention
                ...
                des méthodes de travail et de production, en vue notamment de limiter le travail monotone et le
                travail
    ...
    <section class="page">
        <div class="body body--notif">
            <p>
                <span class="bold">
                    L’évaluation des risques est donc bien placée en tête des principes de prévention par le
                    législateur. C’est elle qui apporte la cohésion
                    nécessaire à la 4ème partie (santé et sécurité au travail) du Code du travail, par sa
                    retranscription dans le « DOCUMENT UNIQUE ».
                </span> <br>
                Le DU centralise en effet toutes les activités professionnelles, leurs dangers, leurs risques et
                leurs
                réglementations spécifiques, notamment (non
                exhaustif) : <br>
                - les facteurs de risque professionnels, <br>
                - les risques d’interférences encadrés par les réglementation « Plan de Prévention » et « PPSPS »,
                <br>
                - les risques liés aux opérations de chargement et de déchargement encadrés par le « Protocole de
                sécurité
                transport »,<br>
                - les risques liés aux installations, matériels et outils encadrés par la réglementation des «
                vérifications
                périodiques »,<br>
                Le DU intègre également toutes les mesures de prévention en place dans l’entreprise. <br>
                Le DU intègre finalement le Plan d’action de réduction des risques ou « programme de prévention ».
                <br>
            </p>
            <p>
                <span class="bold">2.3. L’annexe d'évaluation de l'exposition aux FACTEURS DE RISQUES
                    PROFESSIONNELS du Document Unique</span><br>
                ...
                - La proportion de salariés exposés au-delà des seuils fixés pour les facteurs de risques
                professionnels.
            ...
            <p>
                ...
                Le Code du travail (articles L4161-1 et D4161-1-1) et le Décret n° 2017-1769 du 27/12/2017
                définissent les
                ...
                Depuis le 01/10/2017, seuls les 6 derniers facteurs de risques ci-dessus sont associés à des seuils
                définis
                réglementairement (art. D4161-2).<br>
                L'exposition aux 10 facteurs de risques professionnels est donc évaluée dans votre Document Unique,
                mais
                seule l'exposition aux 6 facteurs de
                risques associés à un seuil est évaluée précisément par rapport aux seuils réglementaires dans
                l'annexe
    ...
    <section class="page">
        <div class="body body--notif">
            <p>
                <span class="bold">2.3.2. De la Prévention à la Compensation, le Compte Professionnel de
                    Prévention (C2P)</span><br>
                Quand les mesures de prévention s’avèrent insuffisantes, certains risques peuvent occasionner ;
                lorsque
                l’exposition se situe au-delà de certains
                seuils, eux aussi définis réglementairement ; des dommages durables, identifiables et irréversibles
                sur sa
                santé des salariés.<br>
                Le législateur a donc instauré au bénéfice des salariés concernés un mécanisme de compensation : le
                Compte
                Professionnel de Prévention en
                vigueur depuis le 01/10/2017, qui est géré par la Caisse Nationale d’Assurance Maladie. <br>
                C’est elle qui informe les salariés de l’ouverture de leur compte et des points qu’ils ont acquis.
                <br>
            </p>
            <p>
                ...
                - Une formation permettant de s’orienter vers un emploi non exposé ou moins exposé à des facteurs de
                risque
                professionnels,<br>
            ...
            <p>
                <span class="bold">2.3.2.2. Déclaration annuelle des expositions aux facteurs de risques
                    professionnels</span><br>
                - Pour les travailleurs titulaires d'un contrat de travail qui demeure en cours à la fin de l'année
                civile,
                l'employeur déclare au terme de chaque année
                civile et au plus tard au titre de la paie du mois de décembre, le ou les facteurs de risques
                professionnels
                auxquels ils ont été exposés au-delà des
                seuils fixés réglementairement au cours de l'année civile considérée. <br>
                - Pour les travailleurs titulaires d'un contrat de travail d'une durée supérieure ou égale à un mois
                qui
                ...
                Dans les deux cas, l’employeur effectue sa déclaration auprès des caisses de Sécurité Sociale dans
                le cadre
                de la DSN.<br>
                L'employeur peut rectifier sa déclaration des facteurs de risques professionnels : <br>
                - Jusqu'au 5 ou au 15 avril de l'année qui suit celle au titre de laquelle elle a été effectuée,
                selon
                l'échéance du paiement des cotisations qui lui est
                applicable ; <br>
                - Dans les cas où la rectification est faite en faveur du salarié, pendant une période de trois
                ans.<br>
            </p>
            <p>
                <span class="bold"> 3. Comment évaluer les risques et comment rédiger le Document Unique et son
                    annexe des risques professionnels dans une logique de prévention ?</span><br>
                <span class="bold">3.1. Qui fait quoi</span><br>
                S’il n’impose aucune forme pour rédiger le Document Unique, le législateur impose à l’employeur
                d’utiliser
                ...
                En effet, depuis le 1er juillet 2012 le Code du travail fait obligation à tout employeur de «
                désigner un ou
                ...
                Ce ou ces salarié(s) dispose(nt) donc des compétences nécessaires à la définition d’une méthode et
                d’un
                outil d’évaluation des risques adaptés à
                l’entreprise. <br>
                Cependant, « si les compétences dans l'entreprise ne permettent pas d'organiser ces activités,
                l'employeur
                peut faire appel, aux intervenants en
                prévention des risques professionnels (IPRP) appartenant au service de santé au travail auquel il
                adhère ou
                enregistrés auprès de la DIRECCTE.
                L’employeur peut en outre faire appel à d’autres ressources extérieures (CARSAT, INRS, OPPBTP,
                ANACT, à des
                consultants...) ».<br>
            </p>
    ...
    <section class="page">
        <div class="body body--notif">
            <p>
                ...
                Le législateur n’impose aucune méthode ni aucune forme pour l’évaluation des risques et la rédaction
                du
                Document Unique. Le second alinéa de
                l’article R4121-1 du code du travail précise néanmoins : « Cette évaluation comporte un inventaire
                des
                ...
                - - L’évaluation des risques d’exposition aux champs électromagnétiques selon les critères précisés
                (art R.
                4453-8). <br>
            </p>
            <p>
            ...
            <p>
                ...
                Le mode opératoire d'évaluation des risques est présenté dans la "Notice explicative de l'évaluation
                des
                risques" ci-contre.<br>
            </p>
            <p>
                <span class="bold">3.2.2. Comment rédiger son annexe d'évaluation de l'exposition aux facteurs de
                    risques professionnels</span><br>
                Sur ce sujet le législateur a posé un cadre précis puisque pour 6 des 10 facteurs de risques, il
                existe un
                seuil d’exposition qui déclenche le mécanisme
                de réparation. <br>
            </p>
            <p>
                <span class="bold">3.2.3. Réalisation du diagnostic « d'exposition aux facteurs de risques
                    professionnels »</span><br>
                On évaluera pour chaque poste de travail, l'exposition à chacun des 6 facteurs de risque de
                l'article
                D.4161-2 du Code du travail ; au regard des
                conditions habituelles de travail caractérisant le poste ; appréciées après application des mesures
                de
                protection collective et individuelle existantes.<br>
                Si pour tous les postes de l'entreprise, dans le cas le plus défavorable, l'exposition ne dépasse
                pas le
                seuil d'un des 6 facteurs de risque, on
                considèrera qu'aucun salarié n'est exposé au delà d'un seuil de pénibilité. <br>
                Si un au moins des seuils est dépassé à un poste de travail, on évaluera l’exposition de tous les
                salariés
                titulaires d'un contrat de travail d'une durée
                d'au moins un mois, quelle que soit la nature du contrat (CDI, CDD, intérim, apprentissage, etc.)
                qui ont
                travaillé à ce poste au cours de l'année, au
                prorata de leur temps de travail annuel à ce poste. <br>
                L'exposition de chaque salarié sera apprécié au regard des conditions habituelles de travail
                caractérisant
                le poste ou l'ensemble des postes occupé(s)
                en moyenne sur l'année entière ; que le contrat de travail porte sur l'année entière ou non. Dans ce
                dernier
                cas, l'exposition sera extrapolée en
                moyenne sur l'année complète. <br>
                L'exposition d’un salarié à temps partiel sera exactement équivalente à celle d’un salarié à temps
                plein (en
    ...
    <section class="page">
        <div class="body body--notif">
            ...
            <p>
                <span class="bold">EVALUATION DES RISQUES PROFESSIONNELS :</span> De gauche à droite du tableau
                d'évaluation
                des risques
            </p>
            <p>
                ...
                Le législateur n'a pas défini "l'unité de travail". Nous l'entendons ici comme un poste de travail,
                un
                métier ou une activité.<br>
                <span class="bold">Les unités de travail sont détaillées dans la partie "Présentation de la
                    structure" de ce Document Unique.</span>
            </p>
            <p>
                <span class="bold">DANGER et dommages potentiels à la personne</span> <br>
                Le danger est la propriété intrinsèque d'un agent (physique, chimique, biologique) susceptible
                d'avoir un
                effet nuisible sur l'Homme. Plus le potentiel de
                nuisance est élevé, plus les conséquences sur l'Homme sont importantes. On parlera des conséquences
                sur la
                ...
                chapitre.<br>
                Nous listons ici tous les dangers potentiellement présents sur les lieux de travail et leurs
                conséquences
                potentielles.<br>
            </p>
            <p>
                <span class="bold">RISQUE, phase de travail modes et caractéristiques de l'exposition (outil,
                    matériel, produit, situation, opération, fréquence, durée)</span><br>
                Nous décrirons ici l'activité professionnelle réelle, en fonctionnement normal et en marche
                dégradée, en
            ...
            <p>
                ...
                - <span class="bold">"Moins de 1 fois par an"</span> correspond à une exposition extrêmement rare
                de moins
                de une fois par an, soit "1" dans la formule de calcul.<br>
                - <span class="bold">"An"</span> correspond à une exposition rare de une à plusieurs fois par an,
                soit "2"
                dans la formule de calcul.<br>
                - <span class="bold">"Mois"</span> correspond à une exposition peu fréquente de une à plusieurs
                fois par
                mois, soit "3" dans la formule de calcul.<br>
                - <span class="bold">"Semaine"</span> correspond à une exposition fréquente de une à plusieurs
                fois par
                semaine, soit "4" dans la formule de calcul.<br>
                - <span class="bold">"Jour"</span> correspond à une exposition très fréquente, de une à plusieurs
                fois par
    ...
    <section class="page">
        <div class="body body--notif">
            <p>
                <span class="bold">Par exemple,</span> une personne emprunte plusieurs fois par jour un escalier
                en se
                tenant à la rampe. La fréquence d'exposition est maximale, mais cela
                ne signifie pas que cette personne aura un accident chaque jour dans cet escalier. La probabilité
                qu'elle
                chute dans cet escalier est "faible" ou "très
                faible". <br>
                La probabilité d'occurrence est évaluée selon une échelle à 5 niveaux : <br>
                - <span class="bold">"très faible"</span> = 0,5 # <span class="bold">"faible"</span> = 2 #
                <span class="bold">"non faible"</span> = 3 # <span class="bold">"élevée"</span> = 4 # <span
                    class="bold">"très élevée"</span>
                = 5.<br>
                Les indices de fréquence et de probabilité permettent de définir une <span class="bold">"classe
                    d'exposition"</span>
            ...
            <p>
                ...
                La gravité potentielle des conséquences de l'exposition à un danger est évaluée selon une échelle à
                5
                niveaux :<br>
                - <span class="bold">"Impact faible"</span> correspond à une exposition sans conséquence sur la
                santé
                physique et mentale de la personne exposée.<br>
                - <span class="bold">"ASA"</span> correspond à un <span class="bold">A</span>ccident ou à une
                maladie
                professionnelle <span class="bold">S</span>ans <span class="bold">A</span>rrêt de travail.
                <br>
                - <span class="bold">"AAA"</span> correspond à un <span class="bold">A</span>ccident ou à une
                maladie
                professionnelle <span class="bold">A</span>vec <span class="bold">A</span>rrêt de travail,
                sans IPP
                (Incapacité Permanente Partielle*).<br>
                - <span class="bold">"IPP"</span> correspond à un accident ou à une maladie professionnelle avec
                arrêt de
                travail et avec IPP (<span class="bold">I</span>ncapacité <span class="bold">P</span>ermanente
                <span class="bold">P</span>artielle*).<br>
                - <span class="bold">"Décès"</span> correspond à au moins une maladie professionnelle avec
                Incapacité
                Permanente Totale ou au moins un décès.<br>
                * L'IPP est constatée lorsqu'il persiste des séquelles de l'accident du travail, alors que le
                salarié est
                déclaré apte.<br>
            ...
            <p>
                ...
                Les lettres "F" pour Femme, ou "H" pour Homme sont utilisées pour identifier le cas échéant le sexe
                pour
                ...
                L'évaluation de l'impact différencié de l'exposition aux risques en fonction du sexe est en effet
                une
                exigence réglementaire. <br>
            </p>
            <p>
                <span class="bold">Risque brut</span> <br>
                Le risque brut correspond au niveau de risque évalué sans prendre en considération les mesures de
                prévention
            ...
            <p>
                ...
                Tous les postes de travail comportant au moins une situation de travail dont le risque brut est >= à
                24 font
                partie de la "Liste des postes de travail à
                risque particulier".<br>
                Tous les salariés embauchés pour travailler à l'un de ces postes, en contrat de travail précaire
                (autre que
                ...
                Liste établie par l'employeur, après avis du médecin du travail, du CHSCT ou, à défaut, des
                représentants du
                personnel, s'il en existe.<br>
                Liste tenue à la disposition des agents de contrôle des agents de l'inspection du travail (amende de
                10 000
    ...
    <section class="page">
        <div class="body body--notif">
            <p>
                ...
                Les mesures de prévention et de protection existantes se déclinent en 3 catégories énoncées dans les
                9
                principes de prévention de l'article L.4121-2
                du Code du Travail (Loi n° 91-1414 du 31 décembre 1991 art. 1 Journal Officiel du 7 janvier 1992 en
                vigueur
                le 31 décembre 1992) :<br>
                Mesure <span class="bold">Technique, Organisationnelle, Humaine (Information et formation,
                    protection collective et individuelle).</span><br>
                Dans chaque catégorie, l'efficacité des différentes mesures de prévention existantes est présentée
                de la
                façon suivante :<br>
                - <span class="bold">"très bon"</span> = mesure existante très efficace : Technique = 6 ;
                Organisationnelle
                et Humaine = 3.<br>
                - <span class="bold">"bon"</span> = mesure existante de bonne efficacité : Technique = 4 ;
                Organisationnelle
                et Humaine = 2.<br>
                ...
                Une pondération est appliquée à la somme des mesures de prévention selon les équivalences suivantes
                :<br>
                T+H+O = 12, pondération = 0,1 ; 11 0,15 ; 10 = 0,2 ; 9 = 0,25 ; 8 = 0,3 ; 7 = 0,35 ; 6 = 0,4 ; 5 =
                0,5 ; 4 =
                0,6 ; 3 = 0,7 ; 2 = 0,8 ; 1 = 0,9.<br>
                <span class="bold">Le risque résiduel correspond donc à : ((F + P) x G) x pondération de (T + O +
                    H)</span>
            </p>
            <p>
                <span class="bold">Criticité = situation actuelle</span><br>
                Le Document Unique doit réglementairement permettre d’identifier les risques les plus critiques afin
                de
                ...
                suivante :<br>
                <span class="text-color-green">« Acceptable »</span> associé à la couleur verte, elle correspond à
                une
                criticité &lt; 12,5.<br>
                La diminution de ce risque n’est pas une priorité. <br>
                <span class="text-color-orange">« A améliorer »</span> associé à la couleur jaune, elle correspond
                à une
                criticité >= 12,5.<br>
                La diminution de ces risque peut être planifiée à moyen / long terme. <br>
                <span class="text-color-pink">« Agir vite »</span> est associé à la couleur rose, elle correspond à
                une
                criticité >= 20.<br>
                La diminution de ces risques est à planifier en priorité. <br>
                <span class="text-color-red">« STOP »</span> est associé à la couleur rouge, elle correspond à une
                criticité
                >=30 <= 50.<br>
                    Ces activités doivent être stoppées immédiatement afin d’identifier et de mettre en place une
                    activité plus
                    sûre.
            </p>
        </div>
    ...
    <section class="page">
        <div class="body body--rules">
            <h1 class="head-title" id="evalRiskPro">5. EVALUATION DES RISQUES PROFESSIONNELS PAR UNITÉ DE TRAVAIL
            </h1>
            <p class="bold">
                Liste des dangers considérés. <br>
                <span class="text-color-red">En gras, dangers présents uniquement dans la version « Conformité » du
                    Document Unique OZA.</span>
            </p>
            <p>
                1. Absence d’une personne « compétente » pour s’occuper des activités de protection et de prévention
                des
                risques professionnels de la structure.
            </p>
            <p>
                2. Accident, presqu’accident et maladie du travail non ou mal analysés et prévenus pouvant générer
                la
                répétition de ces faits.
            </p>
            <p class="bold">
                3. Agents biologiques (bactéries, virus) pouvant générer infections, intoxications, allergies,
                cancers,
                zoonoses.
            </p>
            <p class="bold">
            ...
            <p class="bold">
                5. Agression et violence internes et externes, à caractère sexuel ou non, pouvant mettre en péril la
                santé
                et la sécurité des salariés, notamment : vols, rackets, agression physique, agression verbale.
            </p>
            <p>
                Le harcèlement sexuel se caractérise par le fait d’imposer à une personne, de façon répétée, des
                propos ou
                ...
                Dans le milieu professionnel, il y a harcèlement sexuel même s’il n’y a aucune relation hiérarchique
                entre
                l’agressé(e) et l’auteur des faits (entre collègues de même niveau, de services différents…)<br>
                Si l’auteur des faits a eu un contact physique avec l’agressé(e) il peut s’agir d’une agression
                sexuelle,
                plus gravement punie.<br>
                La victime peut se retourner contre l’auteur des faits en portant plainte dans un délai de 6 ans
                après le
                dernier fait (geste, propos…) lié à ce type de harcèlement. La victime peut également saisir le
                conseil des
            ...
            <p class="bold">
                6. Ambiances thermiques liées aux températures extérieures (hors températures liées aux postes de
                travail)
                pouvant générer fatigue, sueurs, nausées, maux de tête, vertiges, crampes, déshydratation, coup de
                chaleur,
                engourdissement, gelures, hypothermie.
            </p>
            <p>
                7. Amiante pouvant entrainer de graves maladies respiratoires : plaques pleurales, asbestose, cancer
                de la
                plèvre ou du poumon.
            </p>
            <p>
                8. Aptitude au travail, non respectée elle peut générer ou provoquer la rechute d’atteintes à la
                santé un
                accident du travail.
            </p>
        </div>
    ...
    <section class="page">
        <div class="body body--rules">
            <p class="bold">
                9. Bruit pouvant provoquer atteinte auditive, surdité, stress, fatigue FACTEUR DE RISQUE
                PROFESSIONNEL.
            </p>
            <p class="bold">
            ...
            <p class="bold">
                13. Chutes de hauteur y compris chute dans les escaliers, pouvant générer traumatismes, plaies,
                fractures,
                noyade.
            </p>
            <p class="bold">
                14. Circulation à pied pouvant provoquer des chutes de plain-pied (glissades, trébuchements, pertes
                d’équilibre sur une surface “plane” : surfaces ne présentant aucune rupture de niveau ou bien des
                ruptures
                de niveau réduites (trottoir, petites marches, plan incliné, etc.)) ; ou provoquer des chocs à
                l’origine de
            ...
            <p>
                ...
                l’origine d’accidents du travail, notamment par la diminution de la vigilance, l’altération des
                capacités de
                jugement, de la motricité, de la vision et des réflexes.
            </p>
            <p>
                16. Dangers des produits, matériels, installations et activités de l’atelier pouvant générer des
                blessures
                et des atteintes à la santé.
            </p>
            <p class="bold">
                17. Déplacements dans l’enceinte de la structure avec un véhicule motorisé ou non pouvant générer
                des TMS,
                dorso-lombalgies, plaies, traumatismes, fractures, écrasement.
            </p>
            <p class="bold">
                18. Eclairage inadapté pouvant générer éblouissement, fatigue et inconfort visuel, chute,
                traumatisme,
                atteinte visuelle, erreur d’appréciation.
            </p>
            <p>
                19. Ecrans de visualisation pouvant générer fatigue visuelle, troubles musculosquelettiques et
                stress.
            </p>
            <p>
            ...
            <p>
                22. Incapacité à porter secours dans des délais raisonnables, pouvant aggraver la situation
                initiale.
            </p>
            <p>
                23. Incapacité à stopper et prévenir une situation de danger grave et imminent pour la santé ou la
                sécurité.
            </p>
            <p class="bold">
            ...
            <p>
                25. Intempéries telles que la pluie, le vent, la neige, le brouillard, … , hors températures
                extérieures ;
    ...
    <section class="page">
        <div class="body body--rules">
            <p class="bold">
                26. Machines ; outils électroportatifs, thermiques et pneumatiques ; outils à main et équipements de
                travail
                ; pouvant générer des plaies, coupures, lacérations, amputations, brulures, traumatismes, fractures,
                écrasements.
            </p>
            <p class="bold">
                27. Manutentions manuelles pouvant générer TMS, dorso-lombalgie, traumatisme, plaie, coupure,
                brûlures.
            </p>
            <p class="bold">
            ...
            <p>
                29. Méconnaissance de l’évolution de la règlemention en santé et sécurité au travail pouvant générer
                des
                atteintes à la santé et des accidents du travail.
            </p>
            <p>
                30. Méconnaissance des risques et des consignes de sécurité pouvant générer des atteintes à la santé
                et des
                accidents du travail.
            </p>
            <p class="bold">
                31. Milieu hyperbare pouvant générer des accidents et / ou des pathologies de décompression FACTEUR
                DE
                RISQUE PROFESSIONNEL.
            </p>
            <p>
                32. Nanomatériaux et nanoparticules pouvant générer des intoxications principalement par inhalation
                ou
                ingestion.
            </p>
            <p>
                33. Opérations de chargement et de déchargement de véhicule réalisées en coactivité entre la
                structure
                utilisatrice et une entreprise de transport, pouvant générer des atteintes à la santé et / ou des
                accidents.
            </p>
            <p>
            ...
            <p>
                35. Plomb pouvant entrainer des atteintes graves au niveau du système nerveux, au niveau des reins,
                au
                niveau du sang, au niveau du système digestif, et sur le système reproducteur.
            </p>
            <p>
                36. Postures pénibles, travail statique pouvant générer fatigue et douleurs, accidents traumatiques
                et
                cardiovasculaires, TMS, dorso-lombalgies.
            </p>
            <p class="bold">
                37. Rayonnements ionisants pouvant générer des brûlures, des lésions cellulaires, des effets
                cancérogènes,
                mutagènes et reprotoxiques.
            </p>
            <p class="bold">
                38. Rayonnements optiques pouvant générer des atteintes de la peau (brulure, vieillissement, cancer)
                et de
                l’œil (lésions de cornée, conjonctivite, rétine et opacification du cristallin).
            </p>
            <p>
                39. Risques liés à la l’interférence entre plusieurs activités pouvant générer des atteintes à la
                santé et /
                ou des accidents.
            </p>
            <p class="bold">
                40. Risques psychosociaux dont harcèlement moral et sexuel, agression, harcèlement et violence
                internes et
                externes (morale, verbale, physique, à caractère sexuel) pouvant mettre en péril la santé et la
                sécurité des
                salariés, affecter la dignité et le devenir professionnel et / ou générer des maladies
                cardio-vasculaires,
                troubles anxiodépressifs, stress, épuisement professionnel ou burnout, suicide.
            </p>
            <p class="bold">
                41. Risques routiers durant le trajet domicile travail pouvant générer des atteintes traumatiques
                plus ou
    ...
    <section class="page">
        <div class="body body--rules">
            <p class="bold">
                43 Télétravail réalisé au domicile pouvant engendrer des risques physiques (musculosquelettiques,
                visuels,
            ...
            <p>
                ...
                fatigue, sueurs, nausées, maux de tête, vertiges, crampes, déshydratation, coup de chaleur,
                engourdissement,
                gelures, hypothermieFACTEUR DE RISQUE PROFESSIONNEL.
            </p>
            <p>
                45 Travail de nuit entre 21h et 6 heures, ou en équipes successives alternantes pouvant générer des
                troubles
                du sommeil, des troubles cardiovasculaires, des cancers FACTEUR DE RISQUE PROFESSIONNEL
            </p>
            <p>
                46 Travail isolé pouvant générer des contraintes supplémentaires et augmenter les difficultés à
                secourir.
            </p>
            <p>
            ...
            <p class="bold">
                49 Vibrations transmises aux mains et aux bras pouvant générer des pathologies des articulations du
                poignet
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td class="theader max-width">
                            Mesures de prévention et de protection existantes : Technique, Organisationnelle,
                            Protection,
                            Humaine (information)
                        </td>
                        <td class="theader">
                    ...
                    @foreach ($sd_risks_final as $final)
                        @if (!empty($final['sd_risks']))
                            @foreach ($final['sd_risks'] as $sd_risk)
                                <tr>
                                    <td class="workunit">
                                        {{ $final['sd_work_unit'] === 'Tous' ? 'Tous' : $final['sd_work_unit']->name }}
                                    </td>
                                    <td class="danger">{{ $final['sd_danger']->danger->name }}</td>
                                    <td class="risk">{{ $sd_risk->name }}</td>
                                    <td class="center min-width min-width-left">
                                        {{ $sd_risk->translate($sd_risk->frequency, 'frequency') }}</td>
                                    <td class="center min-width min-width-left">
                                        {{ $sd_risk->translate($sd_risk->probability, 'probability') }}</td>
                                    <td class="center min-width min-width-left">
                                        {{ $sd_risk->translate($sd_risk->gravity, 'gravity') }}</td>
                                    <td class="center min-width min-width-left">
                                        {{ $sd_risk->translate($sd_risk->impact, 'impact') }}</td>
                                    <td
                                        class="center min-width min-width-left {{ $sd_risk->total() >= 24 ? 'pink' : '' }}">
                                        {{ $sd_risk->total() }}</td>
                                    <td class="restraint">
                                        @php
                                    ...
                                    <td class="center min-width min-width-right">
                                        {{ count($existsRestraints) ? $sd_risk->totalRR($existsRestraints) : $sd_risk->total() }}
                                    </td>
                                    <td
                                        class="center criticity {{ count($existsRestraints) ? $sd_risk->colorPDF($sd_risk->totalRR($existsRestraints), false) : $sd_risk->colorPDF($sd_risk->total(), true) }}">
                                        {{ count($existsRestraints) ? $sd_risk->colorTotal($sd_risk->totalRR($existsRestraints), false) : $sd_risk->colorTotal($sd_risk->total(), true) }}
                                    </td>
    ...
    <section class="page">
        ...
        <div class="body body--notif">
            <h1 class="head-title" id="listPost">6. LISTE DES POSTES DE TRAVAIL "A RISQUE PARTICULIER" (CODE DU
                TRAVAIL ART.
                I.4154-2)</h1>
            <p class="text-color-red info">
                <span class="bold">Rappel :</span> Tous les salariés embauchés pour travailler à l’un de ces
                postes, en
                contrat de travail précaire (autre que CDI), doivent bénéficier d’une formation renforcée à la
                sécurité,
                ...
                existe.<br>
                Liste tenue à la disposition des agents de contrôle de l’inspection du travail (amende de 10 000
                €uros en
        ...
        <section class="page">
            ...
            <div class="body body--rules">
                ...
                <p>
                    ...
                    Le Ministère du travail Français en donne cette définition sur son site
                    www.travail-emploi.gouv.fr : «
                    Les risques psychosociaux (RPS) sont à l’interface de l’individu et de sa situation de travail
                    d’où le
                    ...
                    <span class="bold">L’agence Européenne</span> pour la sécurité et la santé au travail
                    considère pour sa
                    part que : « Les risques psychosociaux et le stress occasionné par le travail font partie des
                    principaux
                    ...
                    - Le déséquilibre entre la perception qu’une personne a des contraintes de son environnement de
                    travail
                ...
                <p>
                    ...
                    Les risques psychosociaux engendrent également un coût important pour les entreprises à travers
                    une
                    croissance des absences, des inaptitudes, du turnover, des reconnaissances de maladie
                    professionnelle,
                ...
                <p>
                    ...
                    - Ambiguïté et conflits de rôles, imprécision de la définition des responsabilités des
                    travailleurs.<br>
                    - Stagnation et incertitude dans la carrière, promotion insuffisante ou excessive, salaire bas,
                    insécurité professionnelle, valeur sociale du travail insuffisante. - Participation insuffisante
                    à la
                    prise de décision, manque de contrôle sur le travail.<br>
                    - Isolement social ou physique, mauvais rapports avec les supérieurs, conflits interpersonnels,
                    manque
                    ...
                    - Problèmes concernant la fiabilité, la disponibilité, l’adaptation, l’entretien ou la
                    réparation de
                    l’équipement et des moyens.<br>
                    - Manque de variété ou cycles de travail court, travail fragmenté ou insignifiant,
                    sous-utilisation des
                    compétences, grande insécurité.<br>
                    - Surcharge ou manque de travail, manque de contrôle sur le rythme de travail, niveau élevé de
                    pression
                    par rapport au temps imparti pour effectuer le travail.<br>
                    - Travail posté, plannings inflexibles, horaires de travail imprévisibles, longues heures de
                    travail ou
        ...
        <section class="page">
            ...
            <div class="body body--rules">
                ...
                <p>
                    ...
                    - Les réactions physiologiques : maladies hypertensives, affections cardiaques, lésions
                    articulaires de
                    type rhumatismal. Un stress intense se traduit par une forte usure de l’organisme qui affecte la
                    santé.<br>
                    - Les réactions émotionnelles s’expriment par des variations de l’humeur telles que
                    l’irritabilité,
                    l’anxiété ou encore la dépression, phase ultime du stress. Elles peuvent également se manifester
                    par une
                    ...
                    antidépresseurs, voire des réactions violentes ou même des tentatives de suicide ; la diminution
                    de la
                    capacité à traiter l’information est fonction du niveau de stress. A un niveau de stress élevé,
                    l’effort
                    compensatoire atteint son plafond et l’effet différentiel du stress devient clairement
                    observable sur la
                    performance.<br>
                    Constituent des exemples d’agissements constitutifs de risque psychosocial, qu’ils soient commis
                    par un
                    employeur ou un autre salarié : - Ne pas informer le salarié de la tenue des réunions de son
                    service
                    ;<br>
                    - Refus systématique de toutes les demandes de formation et de congés sans justification
                    objective ;<br>
                    - Retrait d’avantages tels que véhicule de fonction, téléphone ou ordinateur portable sans
                    justification
                    objective ;<br>
                    - Mise au « placard », c’est-à-dire suppression progressive des tâches prévues au contrat de
                    travail et
                    isolement ; <br>
                    - Dénigrements systématiques, insultes ou agressions verbales répétitives ;<br>
                    - Charge de travail incompatible avec les compétences et / ou les moyens confiés au salarié
                    ;<br>
                ...
                <p>
                    ...
                    L’évaluation des RPS est un processus complexe. Il nécessite d’observer à la fois l’organisation
                    du
                    ...
                    échanges, questionnaires, réunions, menés avec tous les salariés ou les représentants du
                    personnel. Le
                    service de santé au travail ou des intervenants extérieurs spécialisés peuvent aider à cette
                    évaluation
                    en jouant le rôle d’intermédiaire et de garant de l’objectivité de la démarche.<br>
                    La mise à jour régulière du document unique sur le sujet des risques psychosociaux est
                    impérative. En
                    effet, ces risques évoluent rapidement dans le temps et peuvent ainsi apparaître ou disparaître,
                    notamment lors de restructuration, changement de méthode, de lieux de travail ou de
                    management.<br>
                    Une généralisation du processus d’analyse des risques ne peut être opérée. Mais pour faciliter
                    l’évaluation de ces risques et leur intégration dans le document unique, des outils communs à
                    toutes les
                    branches d’activité existent, notamment les outils et méthodes de l’INRS.<br>
                    La démarche d’analyse de OZA utilisée dans ce Document Unique (ci-après au paragraphe 5) reprend
                    l’outil
                    proposé par l’INRS pour les entreprises de plus de 50 salariés (ED 6140 Outil RPS-DU) en
                    l’adaptant
                ...
                <p>
                    ...
                    Une obligation générale de sécurité incombe à l’employeur. Elle est énoncée de la façon suivante
                    dans la
                    Code du travail : L’employeur prend les mesures nécessaires pour assurer la sécurité et protéger
                    la
                    santé physique et mentale des travailleurs.<br>
                    Le harcèlement moral, le harcèlement sexuel et les agissements sexistes sont interdits en France
                    par le
        ...
        <section class="page">
            ...
            <div class="body body--rules">
                ...
                <p>
                    ...
                    Pour mettre en œuvre sa stratégie de prévention, l’employeur a notamment la possibilité de
                    s’appuyer sur
                    ...
                    - De quantification des facteurs de risques, - De hiérarchisation des facteurs de risques,
                    réalisées
                    ...
                    - La possibilité donnée aux salariés de participer aux changements qui affecteront leur
                    travail,<br>
                    - L’amélioration de la communication de l’entreprise sur sa stratégie afin de réduire les
                    incertitudes,
                    ...
                    -….<br>
                    Le service de santé au travail prendra pour sa part en charge les salariés identifiés en
                    souffrance.
                </p>
        ...
        <section class="page">
            ...
            <div class="body body--rules">
                ...
                <p>
                    ...
                    Le niveau de risque moyen est calculé en effectuant la moyenne pondérée des réponses obtenues
                    pour
                    chaque question avec les pondérations suivantes : « non concerné » = 0 ; « risque faible » =
                    3,33 ; «
                ...
                <p>
                    ...
                    Une analyse du risque psychosocial individuel est également effectuée en examinant chaque
                    questionnaire
                    individuellement.<br>
                    Le nombre de salariés en souffrance est reporté dans le tableau « Niveau de risque Psychosocial
                    individuel ».<br>
                    Les salariés en souffrance sont ceux qui ont répondu de façon extrême à plus de trois questions
                    et qui
                    ont positionné leur réponse au-delà de 66 sur l’échelle de niveau de stress ; et ceux qui ont
                    répondu de
                    façon extrême à la question 21 et qui ont positionné leur réponse au-delà de 66 sur l’échelle de
                    niveau
                ...
                <p>
                    ...
                    Un plan d’action est élaboré et proposé afin de réduire le risque psychosocial moyen et
                    individuel.
                </p>
            </div>
                        ...
                        <tr>
                            <td style="width: 50%">
                                <table class="table table--psycho">
                                    <thead>
                                        <tr>
                                            <th colspan="5" style="height: 28px;">Nombre de questionnaires
                                                exploités</th>
                                    ...
                                    <tbody>
                                        @foreach ($questions as $key => $question)
                                            @if ($key <= 12)
                                                ...
                                                @if (isset($response))
                                                    <tr>
                                                        <td class="td_question">{{ $question->order }} :
                                                            {{ $question->info }}</td>
                            ...
                            <td style="width: 50%">
                                <table class="table table--psycho">
                                    <thead>
                                        <tr>
                                            <th colspan="5" style="height: 25px;">D’une façon générale, comment
        ...
        @foreach ($psychosocial_groups as $psychosocial_group)
            @php
                ...
                foreach ($questions as $key => $question) {
                    $response = $question->responseOfPsyGroupID($psychosocial_group->id);
                    if (isset($response)) {
                        $allCal = $allCal + $response->intensity();
                    }
                }
                if ($all !== 0) {
                    $allCal = $allCal / $all;
                        ...
                        <tr>
                            <td style="width: 50%">
                                <table class="table table--psycho">
                                    <thead>
                                        <tr>
                                            <th colspan="3" class="green text-color-white">Niveau de risque
                                                Psychosocial moyen</th>
                                        </tr>
                                        <tr>
                                                ...
                                                @if (isset($response))
                                                    <tr class="space">
                                                        <td class="td_question">{{ $question->order }} :
                                                            {{ $question->name }}</td>
                                                        <td class="td_all">{{ $response->intensity() }}</td>
                                                        <td class="td_all {{ $response->priorityPDF()['class'] }}">
                                                            {{ $response->priorityPDF()['text'] }}</td>
                                                    </tr>
                                                @endif
                                            @endif
                                        @endforeach
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            <tr class="space">
                                                ...
                                                <td
                                                    class="td_all {{ $response->priorityPDFCustom($allCal)['class'] }}">
                                                    {{ $response->priorityPDFCustom($allCal)['text'] }}</td>
                                            </tr>
                                            <tr class="space">
                                                <td class="td_question">D’une façon générale, comment évaluez-vous
                                                    votre niveau de stress <br> sur une échelle de zéro à 100</td>
                                                <td class="td_all" colspan="2">
                                                    {{ $psychosocial_group->stress_level }}</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
                        ...
                        <tr>
                            <td style="width: 50%">
                                <table class="table table--psycho">
                                    <thead>
                                        <tr>
                                            <th colspan="2" class="green text-color-white">Risque Psychosocial
                                                individuel</th>
                                        </tr>
                                        <tr>
                                            <th class="th_question">Facteurs de risques psychosociaux</th>
        ...
        <section class="page">
            ...
            <div class="body">
                ...
                <table class="table table--action">
                    <thead>
                        <tr>
                            <th colspan="9" class="green">Plan d’action de réduction des Risques Psychosociaux
                            </th>
                        </tr>
                        <tr>
                            <td class="theader">
                    ...
                    <tbody>
                                    ...
                                    @for ($i = 0; $i < count($response->checked_restraints); $i++)
                                        @if ($response->checked_restraints[$i]->checked)
                                            <tr class="space">
                                                ...
                                                <td class="intensity min-width min-width-left">
                                                    {{ $response->intensity() }}</td>
                                                <td class="extreme min-width min-width-left">
                                                    {{ $response->extreme() }}</td>
                                                <td
                                                    class="action min-width min-width-left {{ $response->priorityPDF()['class'] }}">
                                                    {{ $response->priorityPDF()['text'] }}</td>
                                                <td class="restraint">
                                                    {{ $response->checked_restraints[$i]->text }}</td>
                                                <td class="decision">
                                                    {{ $response->checked_restraints[$i]->decision ?: '' }}</td>
                                                <td class="date">
                                                    {{ $response->checked_restraints[$i]->date ? date('d/m/Y', strtotime($response->checked_restraints[$i]->date)) : '' }}
                                                </td>
                                                <td class="comment"></td>
                                            </tr>
                                        @endif
                        ...
                        @if ($all > 0)
                            <tr class="space">
                                ...
                                <td class="td_restraint" colspan="4">Informer le médecin du travail de cette
                                    situation afin qu'il puisse intégrer cette problématique dans ses actions de
                                    prévention.</td>
                            </tr>
                        @endif
                        @if ($is === 0)
    ...
    @if ($single_document->risk_chemical)
        ...
        <section class="page">
            ...
            <div class="body body--rules">
                ...
                <p>
                    <span class="bold">1ère étape : </span> Le Niveau de Danger "ND" de chaque agent chimique
                    utilisé ou généré par l'activité est défini en fonction des phrases de danger de l'agent
                    chimique sur la base de sa FDS ou de sa Fiche Toxicologique INRS.
                </p>

                <p>
                    <span class="bold">2e étape : </span> L'indice de Risque "IR" de chaque agent chimique est
                    défini en fonction des caractéristiques de l’exposition ; ventilation, concentration, durée
                    d’utilisation, protection individuelle utilisée. Cet IR définit le "Risque Résiduel" de chaque
                    agent chimique.
                </p>

                <table class="table table--inv-v2">
                    <tr>
                        <td colspan="3" style="padding-bottom: 20px">La valeur de l'IR obtenue permet de
                            définir les conditions d'utilisation suivantes : </td>
                    </tr>
                    <tr>
                        <td><button class="btn btn-danger btn-hidden">Inacceptable</button><span> de IR 2 à IR
                                5</span></td>
                        <td><button class="btn btn-warning btn-hidden">A améliorer</button><span> de IR 1 à IR
                                0</span></td>
                        <td><button class="btn btn-success btn-hidden">Acceptable</button><span> de IR -1 à IR
                                -5</span></td>
                    </tr>
                </table>
            ...
            <div class="body body--notif">
                ...
                <table class="table table--chemical-data">
                    <thead>
                        ...
                        <tr>
                            <th class="th_work_unit center theader" rowspan="2" style="width: 7%">Unité de
                                Travail</th>
                            ...
                            @foreach ($sd_risks_chemicals as $sd_risk)
                                @if ($sd_risk->validated)
                                    <tr>
                                        ...
                                        <td class="td_RR {{ $sd_risk->criticality_PDF()['class'] }}">
                                            {{ $sd_risk->criticality_PDF()['text'] }}</td>
                                    </tr>
                                @endif
                            @endforeach
                        @else
        ...
        <section class="page">
            ...
            <div class="body body--notif">
                ...
                <table class="table table--chemical-data">
                    <thead>
                        <tr>
                            <th colspan="8" class="green text-color-white">PLAN D'ACTION DE RÉDUCTION DU RISQUE
                                CHIMIQUE</th>
                        </tr>
                        <tr>
                            ...
                            <th class="th_restraint theader" rowspan="2" style="width: 35%">Mesure de
                                prévention et de protection proposées</th>
                            <th class="th_date center theader" rowspan="2">Date de réalisation</th>
                            <th class="th_actions center theader" rowspan="2">Commentaire, complément, autres
                                actions</th>
                                ...
                                @if ($sd_risk->validated)
                                    @if (isset($sd_risk->sd_restraints_exist[0]))
                                        @foreach ($sd_risk->sd_restraints_exist as $sd_restraint)
                                            <tr>
                                                <td class="td_work_unit">{{ $sd_risk->sd_work_unit->name }}</td>
                                                <td class="td_name" style="width: 15% ">{{ $sd_risk->name }}
                                                </td>
                                                <td class="td_activity" style="width: 15%">
                                                    {{ $sd_risk->activity }}</td>
                                                <td class="td_IR" style="width: 4%">{{ $sd_risk->IR() }}</td>
                                                <td class="td_RR {{ $sd_risk->criticality_PDF()['class'] }}">
                                                    {{ $sd_risk->criticality_PDF()['text'] }}</td>
                                                <td class="td_restraint" style="text-align: left">
                                                    {{ $sd_restraint->name }}</td>
                                                <td class="td_date">
                                                    {{ $sd_restraint->date ? date('d/m/Y', strtotime($sd_restraint->date)) : '' }}
                                                </td>
        ...
        <section class="page">
            ...
            <div class="body body--rules">
                ...
                <p>
                    ...
                    L'employeur établit et met à jour un document relatif à la protection contre les explosions,
                    intégré au document unique d'évaluation des risques.<br>
                    Ce document comporte les informations relatives au respect des obligations définies aux articles
                    R. 4227-44 à R. 4227-48 du Code du Travail, notamment :<br>
                    1° La détermination et l'évaluation des risques d'explosion<br>
                    2° La nature des mesures prises pour assurer le respect des objectifs définis à la présente
                    section<br>
                    ...
                    4227-50<br>
                    5° Modalités et les règles selon lesquelles les lieux et les équipements de travail, y compris
                    les dispositifs d'alarme, sont conçus, utilisés et entretenus pour assurer la sécurité<br>
                    6° Le cas échéant, la liste des travaux devant être accomplis selon les instructions écrites de
                    l'employeur ou dont l'exécution est subordonnée à la délivrance d'une autorisation par
                    l'employeur ou par une personne habilitée par celui-ci à cet effet<br>
                    7° La nature des dispositions prises pour que l'utilisation des équipements de travail soit
                    sûre, conformément aux dispositions prévues au livre III<br>
                </p>

                <p class="text-color-green">2. Probabilité d'une atmosphère explosive</p>

                <p>
                    1. Identifier les matières inflammables présentes ou pouvant se former sur le site (liquides
                    inflammables, gaz combustibles, poussières combustibles)<br>
                    2. Identifier les sources de dégagement (stockages, process, fuites)<br>
                    3. Quantifier le dégagement en terme de degré :<br>
                    Continu : dégagement qui se produit en permanence ou dont on s’attend à ce qu’il se produise
                    pendant de longues périodes (+ de 1000 heures par an).<br>
                    Premier degré : dégagement dont on s’attend à ce qu’il se produise de façon périodique ou
                    occasionnelle en fonctionnement normal (10 à 1000 heures par an).<br>
                    Deuxième degré : dégagement dont on s’attend à ce qu’il se produise de façon accidentelle (< 10
                        heures par an).<br>
                        4. Quantifier le degré de ventilation (aptitude à diluer) :<br>
                        - Ventilation forte : Elle est capable de réduire la concentration à la source de dégagement
                        de façon pratiquement instantanée, ce qui conduit à une concentration inférieure à la limite
                        inférieure d’explosivité. Il en résulte une zone d’étendue négligeable.<br>
                        - Ventilation moyenne : Elle est capable de maîtriser la concentration, ce qui conduit à une
                        situation stable dans la limite de la zone pendant que le dégagement est en cours, et dans
                        laquelle l’atmosphère explosible ne persiste pas de façon indue après la fin du dégagement.
                        <br>
                        - Ventilation faible : Elle ne peut maîtriser la concentration pendant que le dégagement est
                        en cours et/ou ne peut empêcher que l’atmosphère explosible persiste de façon indue après la
                        fin du dégagement.<br>
                </p>
        ...
        <section class="page">
            ...
            <div class="body body--rules">
                ...
                <p>
                    ...
                    - Assez bonne : on s’attend à ce que la ventilation existe pendant le fonctionnement normal. Des
                    interruptions sont permises, pourvu qu’elles se produisent de façon peu fréquente et pour de
                    courtes périodes.<br>
                    - Faible : la ventilation ne satisfait pas aux critères d’une ventilation bonne ou assez bonne,
                    toutefois, on ne prévoit pas qu’il y ait des interruptions prolongées.<br>
                    6. Caractériser le type et l'étendue de la zone : 0, 1, 2 et 20, 21, 22, END (Emplacement Non
                    Dangereux) selon le paragraphe ci-après.<br>
                </p>

                <p class="text-color-green">3. Identification des zones ATEX :</p>

                <p>
                    Les zones ATEX sont des zones potentiellement explosibles, c'est-à-dire qu'en présence d'une
                    source d'inflammation, une explosion peut se produire, Pour avoir une zone ATEX, toutes les
                    conditions de l'hexagone ci-dessus doivent donc être réunies, à l'exception de la source
                    d'inflammation,
                    Il existe 6 types de zones, qui sont définies en fonction de la probabilité d'existence d'une
                    zone potentiellement explosible :
                </p>
                ...
                <p>
                    ...
                    permanence, pendant de longues périodes ou fréquemment.<br>
                    Zone 1 : emplacement où une atmosphère explosive consistant en un mélange d'air et de substances
                    ...
                    substances inflammables sous forme de gaz, de vapeur ou de brouillard n'est pas susceptible de
                    se présenter en fonctionnement normal ou, si elle se présente néanmoins, elle n'est que de
                    courte durée.<br>
                </p>

                <p>
                    <span class="bold">Pour les atmosphères explosives poussières :</span><br>
                    Zone 20 : emplacement où une atmosphère explosive sous forme de nuage de poussières combustibles
                    est présente dans l'air en permanence, pendant de longues périodes ou fréquemment.<br>
                    Zone 21 : emplacement où une atmosphère explosive sous forme de nuage de poussières combustibles
                    est susceptible de se présenter occasionnellement en fonctionnement normal.<br>
                    ...
                    néanmoins, elle n'est que de courte durée.<br>
                    L'analyse des zones ATEX ne se fait qu'en fonctionnement normal. Seul des dysfonctionnement
                    raisonnablement prévisibles sont étudiés (fuite, renversement …)<br>
                </p>
        ...
        <section class="page">
            ...
            <div class="body body--rules">
                ...
                <p>
                    ...
                    La probabilité d'apparition d'une source d'ignition est établie après prise en compte des moyens
                    de prévention et de protection existant et de leur fiabilité (contrôle) selon les 4 niveaux
                    suivants :<br>
                    Probabilité 4 : source présente constamment ou fréquemment, Ex : four<br>
                    Probabilité 3 : pas présente constamment ou fréquemment, Ex : électricité statique, point chaud
                    lié à un véhicule, choc métal/métal<br>
                    Probabilité 2 : présente dans des circonstances rares, Ex : foudre<br>
                    Probabilité 1 : présente dans des circonstances très rares, Ex : défaillance sur un
                    équipement<br>
                </p>
                ...
                <p>
                    <span class="bold">Probabilité d'apparition d'une source d'ignition</span><br>
                    La criticité "<span class="text-color-green">Acceptable</span>" correspond à une explosion
                    improbable, elle est associé à la couleur verte et ne nécessite pas d'amélioration.<br>
                    La criticité "<span class="text-color-yellow">A améliorer</span>" correspond à une explosion
                    peu probable, elle est associée à la couleur orange et nécessite une amélioration qui peut être
                    planifiée à moyen terme.<br>
                    La criticité "<span class="text-color-pink">Agir vite</span>" correspond à une explosion
                    probable, elle est associée à la couleur rouge et nécessite une amélioration à planifier en
                    priorité.<br>
                    La criticité "<span class="text-color-red">STOP</span>" correspond à une explosion très
                    probable, elle est associée à un fond rouge et nécessite l'arrêt des activités afin d'identifier
                    et de mettre en place des actions de réduction de risques immédiates.<br>
                </p>
        ...
        <section class="page">
            ...
            <div class="body body--rules">
                ...
                <p>
                    ...
                    Ces appareils sont exclus du champ d’application réglementaire considéré ici ; ils font en effet
                    obligatoirement l’objet d’un marquage CE attestant de leur niveau de sécurité par rapport au
                    risque de fuite de gaz, et échappent de fait à l’obligation de marquage ATEX.<br>
                    ...
                    - les becs bunsen,<br>
                    - les gazinières.<br>
                    Toutefois, concernant l’identification et la classification des zones dangereuses, nous retenons
                    ici les zones susceptibles d’être créées par des fuites de gaz autres qu’à l’intérieur de ces
                    équipements (par exemple autre qu’à l’intérieur d’un four ou d’une chaudière), pour permettre de
                    s’assurer ultérieurement de l’aptitude des appareils autres qu’appareils à gaz à fonctionner
                    dans de telles zones.<br>
                </p>

                <p>
                    <span class="bold">Emplacements en plein air</span><br>
                    De manière générale, les conditions de ventilation offertes par les emplacements en plein air
                    seront considérées comme de degré « moyen », et de disponibilité « bonne ».
                </p>

                <p>
                    <span class="bold">Produits comburants et réactions chimiques</span><br>
                    Les risques liés spécifiquement aux produits comburants (oxygène, bioxyde de chlore, chlorate de
                    soude) ou aux réactions chimiques potentiellement explosives ne sont pas pris en compte dans le
                    cadre de la présente analyse (ces phénomènes étant indépendants de la maîtrise des sources
                    d’ignition).
                </p>
                ...
                <p>
                    Concernant l’utilisation de produits étiquetés inflammables, le stockage de faibles quantités de
                    récipients contenant des liquides inflammables ne nécessite pas de classement.<br>
                    Les produits chimiques doivent être stockés en respectant les règles de compatibilité et de
                    rétention des produits chimiques.<br>
                    Concernant les stockages de bidons type carburants pour véhicules, l’absence de zone en cas de
                    déversement accidentel pourra être envisagée si des mesures particulières de prévention sont
                    mises en œuvre, comme par exemple l’utilisation exclusive de contenant renforcés, équipés de
                    dispositifs anti-renversements, …<br>
                </p>
        ...
        <section class="page">
            ...
            <div class="body body--notif">
                ...
                <table class="table table--chemical-data">
                    <thead>
                        <tr>
                            <th colspan="14" class="green text-color-white">ÉVALUATION DES RISQUE D'EXPLOSION
                            </th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <th class="th_spawn_probability theader" style="width: 6%">Probabilité d'apparition
                            </th>
                            <th class="th_prevention theader">Moyens de prévention existants</th>
                            <th class="th_prevention_probability theader" style="width: 5%">Probabilité avec
                                prévention</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            @foreach ($sd_risks_explosions as $sd_risk)
                                <tr>
                                    ...
                                    <td class="td_availability_ventilation">
                                        {{ $sd_risk->availability_ventilation }}</td>
                                    ...
                                    <td class="td_prevention_probability">{{ $sd_risk->prevention_probability }}
                                    </td>
                                    <td class="td_p10 cat_danger {{ $sd_risk->criticality_PDF()['class'] }} ">
                                        {{ $sd_risk->criticality_PDF()['text'] }}</td>
                                </tr>
                            @endforeach
                        @else
        ...
        <section class="page">
            ...
            <div class="body body--notif">
                ...
                <table class="table table--chemical-data">
                    <thead>
                        <tr>
                            <th colspan="7" class="green text-color-white">PLAN D'ACTION DE RÉDUCTION DU RISQUE
                                D'EXPLOSION</th>
                        </tr>
                        <tr>
                            <th class="th_material_explosion center theader" rowspan="2">Matière explosible
                            </th>
                            <th class="th_cat center theader" colspan="2">Produit concerné</th>
                        ...
                        @if (count($sd_risks_explosions) > 0)
                            @foreach ($sd_risks_explosions as $sd_risk)
                                @if (isset($sd_risk->sd_restraints_exist[0]))
                                    @foreach ($sd_risk->sd_restraints_exist as $sd_restraint)
                                        <tr>
                                            <td class="td_material_explosion">{{ $sd_risk->material_explosion }}
                                            </td>
                                            <td class="td_gas">{{ $sd_risk->gas }}</td>
                                            <td class="td_dust">{{ $sd_risk->dust }}</td>
                                            <td class="td_criticality {{ $sd_risk->criticality_PDF()['class'] }}">
                                                {{ $sd_risk->criticality_PDF()['text'] }}</td>
                                            <td class="td_restraint" style="text-align: left">
                                                {{ $sd_restraint->name }}</td>
                                            <td class="td_date">
    ...
    <section class="page">
        ...
        <div class="body body--notif">
            ...
            <p>
                ...
                1° Les données de l’évaluation de l’exposition aux facteurs de risques professionnels de nature à
                faciliter
            ...
            <table class="table table--frp">
                <thead>
                    ...
                    <tr>
                        ...
                        <td class="theader">
                            Proportion de salariés exposés aux facteurs de risques professionnels au-delà des seuils
                            prévus
                        </td>
                    </tr>
                </thead>
                                ...
                                foreach ($danger->sd_works_units->whereNotNull('sd_expositions_questions') as $sd_work_unit) {
                                    foreach ($danger->danger->exposition->exposition_groups as $key => $exposition_group) {
                                        foreach ($exposition_group->exposition_questions as $key => $exposition_question) {
                                            ...
                                            if ($sd_expo_question) {
                                                if ($exposition_group->calculation($sd_expo_question->value) === 'red') {
                                                    $numberEmExpo = $numberEmExpo + $sd_expo_question->number_employee;
                                                }
                                            }
                                        }
                                    }
    ...
    <section class="page">
        ...
        <div class="body body--notif">
            ...
            <p class="text-color-red">
                ...
                Seules les unités de travail concernées par une exposition sont présentées. Ce qui implique que les
                unités
            ...
            <table class="table table--risk-post">
                <thead>
                    ...
                    <tr>
                        ...
                        <td class="theader">
                            Exposition appréciée après application des mesures de protection collective et
                            individuelle
                        </td>
                        <td class="theader">
                                    ...
                                    @foreach ($exposition_group->exposition_questions as $key => $exposition_question)
                                        ...
                                        @if (count($sd_expos_questions))
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($exposition_group->type === 'default')
                                                        {{ $exposition_group->value_label . ' : ' }} <span
                                                            class="text-color-{{ $exposition_group->calculation($sd_expo_question->value) }}">{{ $sd_expo_question->value }}</span>
                                                    @else
                                                        Durée en mm / j <span
                                                            class="text-color-{{ $exposition_group->calculation($sd_expo_question->minutes) }}">{{ $sd_expo_question->minutes }}
                                                        </span>
                                                        <br>
                                                        Durée en h / an <span
                                                            class="text-color-{{ $exposition_group->calculation($sd_expo_question->value) }}">{{ $sd_expo_question->value }}</span>
                                                ...
                                                @endif
                                                <td
                                                    class="center {{ $exposition_group->calculation($sd_expo_question->value) }}">
                                                    {{ $exposition_group->translate($sd_expo_question->value) }}
                                                </td>
                                            </tr>
                                        @endif
                                    @endforeach
                ...
                <tbody>
                    @foreach ($sd_restraints_archived as $sd_restraint_archived)
                        <tr>
                            ...
                            <td class="criticity center {{ $sd_restraint_archived->colorPDF() }}">
                                {{ $sd_restraint_archived->colorTotal() }}</td>
