        ...
        <div class="card-body">
            <div class="row">
                <div class="line">
                    ...
                    <div class="right">
                        <textarea type="text" class="form-control" name="name_risk" id="workName" placeholder="Vente - Boulangerie pâtisserie">@if(old('name_risk')){{ old('name_risk') }}@else{{ isset($risk) ? $risk->name : '' }}@endif</textarea>
                    </div>
                </div>
                @error('name_risk')
                    <div class="line">
