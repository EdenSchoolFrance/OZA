                    ...
                    <tbody>
                        @foreach ($sd_risks as $sd_risk)
                            <tr>
                                ...
                                <td class="td_rr" data-sort="{{ isset($sd_risk->sd_restraints_exist[0]) ? $sd_risk->totalRR($sd_risk->sd_restraints_exist) : $sd_risk->total() }}">
                                ...
                                <td class="td_criticality" data-sort="{{ isset($sd_risk->sd_restraints_exist[0]) ? $sd_risk->totalRR($sd_risk->sd_restraints_exist) : $sd_risk->total() }}">
                        ...
                        @if (count($sd_risks) == 0)
                            <tr class="no-data no-data--centered">
                                <td colspan="{{ !Auth::user()->hasPermission('READER') ? 9 : 8 }}">Aucune risque</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
